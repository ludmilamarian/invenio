...
def rank_records(req, rank_method_code, rank_limit_relevance, hitset_global, pattern=None, verbose=0, sort_order='d', of='hb', ln=CFG_SITE_LANG, rg=None, jrec=None, field='', sorting_methods=SORTING_METHODS, kwargs={}):
    ...
    if obelix and rank_method_code == "rrm":
        user_id = collect_user_info(req)['uid']
        solution_recs, solution_scores = obelix.rank_records(hitset_global, user_id, rg=rg, jrec=jrec)
...
def prs_print_records(kwargs=None, results_final=None, req=None, of=None, cc=None, pl_in_url=None,
    ...
    try:
        obelix.log('search_result',
                   clean_user_info(collect_user_info(req)),
                   original_result_ordered,
