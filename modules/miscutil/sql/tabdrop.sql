...
DROP TABLE IF EXISTS ATLASPublDraft_alert;
...
DROP TABLE IF EXISTS pidSTORE;
DROP TABLE IF EXISTS pidLOG;
DROP TABLE IF EXISTS swrCLIENTSERVER;
DROP TABLE IF EXISTS swrCLIENTSUBMISSION;
DROP TABLE IF EXISTS swrCLIENTTEMPSUBMISSION;
-- end of file
